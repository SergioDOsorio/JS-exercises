    ...
    return (
        <>
            ...
            <div className='bin2Dec'>
                <label htmlFor="decimal" maxLength={8}>Type the decimal to convert it to a Bianry value</label>
                <div className='align'>
                ...
                <br />
                <label htmlFor="binary" maxLength={8}>Type a binary to convert it to a Decimal value</label>
                <div className='align'>
